...
SKIP_METHODS = [('State', 'getPositions'),
                ...
                ('IntegrateNoseHooverChainStepKernel',),
...
("DrudeNoseHooverChainIntegrator", "getDrudeTemperature") : ("unit.kelvin", ()),
("DrudeNoseHooverChainIntegrator", "getMaxDrudeDistance") : ("unit.nanometer", ()),
...
("DrudeNoseHooverChainIntegrator", "getDrudeFriction") : ("1/unit.picosecond", ()),
